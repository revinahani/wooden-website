											...
											<div class="card-body">
												<form action="" method="POST" class="form-item" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
														...
														<input name="namaproduk" value="<?php echo $data['namaproduk'] ?>" type="text" class="form-control" required autofocus>
													</div>
													
                                                    <div class="form-group">
														<label>Nama Kategori</label>
														<select name="idkategori" value="<?php echo $data['idkategori'] ?>" class="form-control">
													...
													<div class="form-group">
														...
														<input name="deskripsi" value="<?php echo $data['deskripsi'] ?>" type="text" class="form-control" required>
													</div>
