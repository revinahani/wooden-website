		...
		<div class="container">
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					// $no=1;
					$brg = mysqli_query($conn, "SELECT * FROM konfirmasi where orderid = '$idorder'");
					// $brg = $conn->query("SELECT * FROM konfirmasi WHERE orderid = '$idorder'");
					$rows = [];
						...
						<?php foreach ($rows as $row) : ?>
							<tr class="rem1">
								<form method="post">
									...
									<td class="invert"><?= $row['orderid']; ?></td>
									<td class="invert"><?= $row['payment']; ?></td>
									<td class="invert"><?= $row['namarekening']; ?></td>
									<td class="invert"><?= $row['tglbayar']; ?></td>
									<td class="invert"><?= $row['alamatpengiriman']; ?></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
